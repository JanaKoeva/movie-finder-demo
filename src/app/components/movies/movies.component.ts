...
export class MoviesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.inTheatreMovies = data.slice(0, 6);
    this.nowPlayingMovies = data.slice(6, 12);
    this.popularMovies = data.slice(12, 18);
    this.topRatedMovies = data.slice(18);

    console.log(this.inTheatreMovies);
